...
class CartPage extends StatelessWidget {
                                              ...
                                              child: Container(
                                                ...
                                                decoration: BoxDecoration(
                                                    image: DecorationImage(
                                                        image: CachedNetworkImageProvider(((Provider.of<
                                                                    ShopProvider>(
                                                                context,
                                                                listen: false)
                                                            .shops
                                                            .where((element) =>
                                                                ...
                                                                foodCart[index]
                                                                    [Constants.shopName])
                                                            .elementAt(0)) as Map)[Constants.imgUrls][0]),
                                                        fit: BoxFit.contain)),
                                              ),
                                            ),
                                            SizedBox(
                                            ...
                                            Expanded(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    '$currency${foodCart[index][Constants.amount].reduce((value, element) => value + element)}',
                                                    style: TextStyle(
                                                        fontSize:
                                                            Dimensions.font16,
                                                        fontWeight:
                                            ...
                                            Expanded(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    '$currency${prodData[index][Constants.prodNewPrice]}',
                                                    style: TextStyle(
                                                        fontSize:
                                                            Dimensions.font16,
                                                        fontWeight:
                                                  ...
                                                  prodData[index][Constants
                                                      ...
                                                      ? Row(
                                                          children: [
                                                            Text(
                                                              '$currency${prodData[index][Constants.prodOldPrice]}',
                                                              style: TextStyle(
                                                                  fontSize:
                                                                      Dimensions
                                                                          .font12,
                                                  ...
                                                  IconBox(
                                                    ...
                                                    isDisabled: Provider.of<GlobalProvider>(
                                                        ...
                                                        : (Provider.of<CartProvider>(
                                                                ...
                                                                null
                                                            ? (Provider.of<CartProvider>(context).cart[Provider.of<CartProvider>(context, listen: false).carts[index][Constants.productId]] < 2 ? true : false)
                                                            : false),
                                                    right: 0,
                                                  ),
                                                  SizedBox(
                  ...
                  pressed: () async {
                    ...
                    for (var element
                        in Provider.of<CartProvider>(context, listen: false)
                            .carts) {
                      if (element[Constants.prodCategory] == 'Cooked Foods') {
                    ...
                    await Provider.of<OrderProvider>(context, listen: false)
                        .createOrder(FirebaseAuth.instance.currentUser!.uid,
                            amount, quantity, prodData, context)
                        .then((value) {
                      Provider.of<GlobalProvider>(context, listen: false)
  ...
  Widget _showDialog(context, String? prodId, List<double> amount,
      bool showSaved, String? shopName) {
          ...
          children: [
            RichText(
              text: TextSpan(children: [
                TextSpan(text: 'FOOD CART'),
                TextSpan(text: '(Jay Shop)'),
              ]),
            ),
            Text('Items:'),
            ListView.builder(
