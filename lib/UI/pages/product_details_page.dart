...
class _ProductDetailsPageState extends State<ProductDetailsPage> {
  getProdDetails() async {
    return await Provider.of<ProductProvider>(context, listen: false)
        .getProductData(widget.prodId);
  }

  getReviews() async {
    return await Provider.of<ProductProvider>(context, listen: false)
        .fetchAllReviews(widget.prodId);
  }
      ...
      body: FutureBuilder(
        ...
        builder: (context, AsyncSnapshot snapshot1) {
          return FutureBuilder(
            future: getProdDetails(),
            builder: (context, AsyncSnapshot snapshot2) {
              return SingleChildScrollView(
                child: snapshot2.data.isEmpty &&
                            ...
                            children: [
                              Container(
                                ...
                                child: CarouselSlider.builder(
                                  ...
                                  itemCount: snapshot2.data[Constants.imgUrls].length,
                                  itemBuilder: (context, index, realIndex) {
                                    return _buildPageItem(
                                        snapshot2.data[Constants.imgUrls][index],
                                        index);
                                  },
                                ),
                              ),
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '\$ ${snapshot2.data[Constants.prodNewPrice]}',
                                      style: TextStyle(
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Delivery \$ ${snapshot2.data[Constants.deliveryPrice]}',
                                                style: TextStyle(
                                                    fontSize:
                                                        Dimensions.font12),
                                              ),
                                  ...
                                  children: [
                                    Material(
                                      ...
                                      child: ListTileBtn(
                                        ...
                                        args: [
                                          snapshot2.data[Constants.prodDescription],
                                          snapshot2.data[Constants.prodKeyFeatures],
                                          snapshot2.data[Constants.prodSpecifications]
                                        ],
                                      ),
                                    ),
                                    SizedBox(
                                    ...
                                    Container(
                                        padding: EdgeInsets.symmetric(
                                            horizontal:
                                                Dimensions.sizedBoxWidth10),
                                        child: Column(
                                          children: snapshot1.data.map((e) {
                                            return Column(
                                              children: [
                                                ReviewBoxCon(
                                                    date: snapshot1.data[
                                                        snapshot1.data.indexOf(e)],
                                                    topic: e[
                                                        Constants.reviewTitle],
                                                    review:
                                                        e[Constants.reviewBody],
                                                    name: e[Constants.name]),
                                                snapshot1.data[snapshot1.data.indexOf(e)] <
  ...
  Widget _buildPageItem(String imgUrl, int index) {
    return Container(
  ...
  Widget _showDialog(context, double deliveryPrice) {
    return Dialog(
      insetPadding:
